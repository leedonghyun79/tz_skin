...
<style>
    ...
    /* ----------------------------------------------------
       ...
       (Avoids flex conflicts with Cafe24's inline display:block)
       ---------------------------------------------------- */
       
    /* Parent Clearfix */
    div[module="product_action"] > div {
        overflow: hidden !important;
    }
    
    /* Set common child styles */
    div[module="product_action"] > div > a.btnSubmit,
    div[module="product_action"] > div > span.gActionButtonColumn,
    div[module="product_action"] .ec-base-button > a,
    div[module="product_action"] .ec-base-button > button#actionCart,
    div[module="product_action"] .ec-base-button > button#actionCartClone {
        width: 49% !important;
        box-sizing: border-box !important;
        margin: 0 !important;
        display: block !important;
    ...
    /* PC: Buy Now (Right), Cart Span (Left) */
    div[module="product_action"] > div > a.btnSubmit {
    ...
    /* Mobile: Buy Now (Right), Cart Button (Left) */
    div[module="product_action"] .ec-base-button > a {
        float: right !important;
        text-align: center !important;
    }
...
files.forEach(f => {
    if(fs.existsSync(f)) {
        ...
        console.log('Fixed button side-by-side using float in ' + f);
    }
});
