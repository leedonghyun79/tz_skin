...
<style>
    ...
    .infoArea th, .ec-base-product th {
    ...
    function addOptionHeadings(selects) {
        ...
        selects.forEach(function(select, index) {
            ...
            if (titleText !== "" && !tr.dataset.headingAdded) {
                ...
                // Match padding and border to requested styling (#e5e5e5 border, 15px padding)
                var paddingTop = '15px';
...
files.forEach(f => {
    if(fs.existsSync(f)) {
        ...
        console.log('Fixed TH width and border styles in ' + f);
    }
});
