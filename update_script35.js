...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function addOptionHeadings(selects) {
        ...
        // REMOVED the logic that added the 1px solid #333 after the last select.
        // It is now handled purely by CSS on .totalPrice to ensure it stays at the very bottom.
    }
...
files.forEach(f => {
    if(fs.existsSync(f)) {
        ...
        console.log('Moved dark border to .totalPrice in ' + f);
    }
});
