...
<style>
    ...
    .totalPrice .total {
        ...
        text-align: right !important; /* Align total price to the right */
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function formatTotalPrice() {
        ...
        selectedProducts.forEach(function(tr) {
            // If the row is visible and contains a quantity input (mobile uses tel/number, pc uses text)
            if (tr.style.display !== 'none' && !tr.classList.contains('displaynone') && !tr.classList.contains('custom-option-heading')) {
        ...
        totalPriceDivs.forEach(function(totalPriceDiv) {
            ...
            if (hasOptions && !hasSelectedProduct) {
                ...
                totalPriceDiv.style.setProperty('display', 'block', 'important');
            }
...
files.forEach(f => {
    if(fs.existsSync(f)) {
        ...
        console.log('Fixed initial display issue for total price in ' + f);
    }
});
