...
<style>
    ...
    /* Make Buy Now and Cart side-by-side 50/50 */
    /* Target both PC (div:first-child) and Mobile (.ec-base-button) wrappers */
    div[module="product_action"] > div:not([id]):not(.soldout):not(.displaynone),
    div[module="product_action"] .ec-base-button:not(.soldout):not(.displaynone) {
        ...
        width: 100% !important;
        padding: 10px 0 !important; /* give some breathing room if needed */
    }
    
    /* Set children to take 50% width */
    div[module="product_action"] > div:not([id]):not(.soldout):not(.displaynone) > a,
    div[module="product_action"] > div:not([id]):not(.soldout):not(.displaynone) > span.gActionButtonColumn,
    div[module="product_action"] .ec-base-button:not(.soldout):not(.displaynone) > a,
    div[module="product_action"] .ec-base-button:not(.soldout):not(.displaynone) > button#actionCart,
    div[module="product_action"] .ec-base-button:not(.soldout):not(.displaynone) > button#actionCartClone {
        flex: 1 !important;
        width: 50% !important;
        margin: 0 !important;
        box-sizing: border-box !important;
    ...
    /* Make anchor tags flex to center text vertically and horizontally */
    div[module="product_action"] > div:not([id]):not(.soldout):not(.displaynone) > a,
    div[module="product_action"] .ec-base-button:not(.soldout):not(.displaynone) > a {
        display: flex !important;
    ...
    /* Fix order to make it consistent (Cart Left, Buy Right) */
    div[module="product_action"] > div:not([id]):not(.soldout):not(.displaynone) > a,
    div[module="product_action"] .ec-base-button:not(.soldout):not(.displaynone) > a {
        order: 2 !important;
    }
    ...
    /* Ensure Cart takes up full width of its half (for PC wrapper span) */
    span.gActionButtonColumn {
        display: flex !important;
    }
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function cleanOptions() {
        ...
        optionSelects.forEach(function(select) {
            ...
            // Add a specific class to the option TR so we can style just the option THs
            var tr = select.closest('tr');
...
files.forEach(f => {
    if(fs.existsSync(f)) {
        ...
        console.log('Fixed regular text row alignment in ' + f);
    }
});
