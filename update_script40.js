...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function formatTotalPrice() {
        ...
        selectedProducts.forEach(function(tr) {
            if (tr.querySelector('input[type="text"]') || tr.className.includes('option_product') || tr.className.includes('option_products')) {
        ...
        totalPriceDivs.forEach(function(totalPriceDiv) {
            ...
            if ((hasOptions && !hasSelectedProduct) || qtyNum === 0) {
...
files.forEach(f => {
    if(fs.existsSync(f)) {
        ...
        console.log('Applied conditional total price display logic in ' + f);
    }
});
