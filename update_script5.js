        ...
        selects.forEach(function(select, index) {
            ...
            if (tr && !tr.dataset.headingAdded) {
                ...
                if (titleText !== "") {
                    ...
                    var borderTop = 'none'; // REMOVED BORDER TOP
                    
                    titleTr.innerHTML = '<td colspan="2" style="padding-top:'+paddingTop+'; padding-bottom:10px; border-bottom:none; border-top:'+borderTop+'; text-align:left;"><strong style="font-size:14px; color:#333; font-weight:bold;">' + titleText + '</strong></td>';
...
files.forEach(f => {
    if(fs.existsSync(f)) {
        ...
        console.log('Removed border-top in ' + f);
    }
});
