...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function formatSelectedOptions() {
        ...
        trs.forEach(function(tr) {
            ...
            // Check if it's a valid option row (has a quantity input or specific class)
    ...
    function cleanOptions() {
        ...
        // Format the selected options layout
...
files.forEach(f => {
    if(fs.existsSync(f)) {
        ...
        console.log('Fixed selected options layout in ' + f);
    }
});
