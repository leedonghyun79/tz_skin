        ...
        selects.forEach(function(select, index) {
            ...
            if (tr && !tr.dataset.headingAdded) {
                ...
                if (titleText !== "") {
                    ...
                    titleTr.innerHTML = '<td colspan="2" style="width:100%; padding-top:'+paddingTop+'; padding-bottom:10px; border:none; text-align:left;"><strong style="font-size:14px; color:#333; font-weight:bold; display:block; width:100%;">' + titleText + '</strong></td>';
